...
def backward(X, y_true, W1, b1, W2, b2, hidden_output, y_pred, learning_rate, lambda_L2):
    N = X.shape[0]
...
def save_parameters(parameter2save,filename='parametersL2'):
    with open(filename, 'wb') as file:
        pickle.dump(parameter2save, file)

def load_parameters(filename='parametersL2'):
    try:
...
if parameters is not None:
    ...
    print("notice: You can delete ./parametersL2 and run again to regenerate local parameters")
else:
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, X_train.shape[0], batch_size):
            ...
            #backward
            W1, b1, W2, b2 = backward(X_batch, y_batch, W1, b1, W2, b2, hidden_output, y_pred, learning_rate, lambda_L2)
    ...
    print("parameters saved to ./parametersL2!")
