...
def backward(X, y_true, W1, b1, W2, b2, hidden_output, y_pred, learning_rate, gamma, V_W1, V_b1, V_W2, V_b2, lambda_L2):
...
def save_parameters(parameter2save,filename='parametersL2M'):
    with open(filename, 'wb') as file:
        pickle.dump(parameter2save, file)

def load_parameters(filename='parametersL2M'):
    try:
...
if parameters is not None:
    ...
    print("notice: You can delete ./parametersL2M and run again to regenerate local parameters")
else:
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, X_train.shape[0], batch_size):
            ...
            #backward
            W1, b1, W2, b2, V_W1, V_b1, V_W2, V_b2 = backward(X_batch, y_batch, W1, b1, W2, b2, hidden_output, y_pred, learning_rate, gamma, V_W1, V_b1, V_W2, V_b2, lambda_L2)
    ...
    print("parameters saved to ./parametersL2M")
